...
public class LeaveOwnerToFollowTargetSystem : IExecuteSystem
{
    public void Execute()
    {
        var entities = Context<Game>.AllOf<InRadiusRangeComponent, FollowAroundTargetComponent>().GetEntities();
        ...
        foreach (var skillEntity in entities)
        {
            ...
            var radiusRange = skillEntity.GetComponent<InRadiusRangeComponent>();
